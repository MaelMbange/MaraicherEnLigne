...
public class HandlerScript implements HttpHandler {
    @Override
    public void handle(HttpExchange exchange) throws IOException {
        ...
        if(method.equalsIgnoreCase("GET")){
            ...
            if(requestPath.endsWith(".js")){
                File file = new File("html" + requestPath);
                System.out.println(Colors.BrightGreen + "script file found: " + file.exists() + Colors.Default);
